...
public class StockQuoteLocator extends org.apache.axis.client.Service implements de.oose.webservice.soap.service.stockrate.StockQuote {
    ...
    private java.lang.String StockQuoteSoap_address = "http://www.webservicex.com/stockquote.asmx";
    ...
    public de.oose.webservice.soap.service.stockrate.StockQuoteSoap getStockQuoteSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.oose.webservice.soap.service.stockrate.StockQuoteSoapStub _stub = new de.oose.webservice.soap.service.stockrate.StockQuoteSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.oose.webservice.soap.service.stockrate.StockQuoteSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                de.oose.webservice.soap.service.stockrate.StockQuoteSoapStub _stub = new de.oose.webservice.soap.service.stockrate.StockQuoteSoapStub(new java.net.URL(StockQuoteSoap_address), this);
                _stub.setPortName(getStockQuoteSoapWSDDServiceName());
                return _stub;
            }
        }
